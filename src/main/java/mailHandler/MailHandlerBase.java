...
public class MailHandlerBase {
    public void sendMail(String myObjectAsString)
    {
        ...
        try {
            ...
            mailMessage.setSubject("Sachin Mailing class");
            mailMessage.setRecipient(Message.RecipientType.TO, new InternetAddress("sachinshukla625@gmail.com"));
            mailMessage.setText("Sachin is trying to send mailing through java!!!");
